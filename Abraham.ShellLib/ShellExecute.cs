namespace Abraham.ShellLib
{
	public class ShellExecute
	{
		...
		public int Execute(string path, string parameters = "", string workingFolder = "", string verb = "open", ShowWindowCommands showMode = ShowWindowCommands.SW_SHOWNORMAL)
		{
			var ownerHandle = IntPtr.Zero;
			var iRetVal = (int)ShellApi.ShellExecute(ownerHandle, verb, path, parameters, workingFolder, (int)showMode);
			return iRetVal;
		}
	}
}